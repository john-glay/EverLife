...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2024 at 03:23 PM
...
INSERT INTO `dependent` (`pin`, `dep_id`, `dep_name`, `dep_birth_date`, `dep_citizenship`, `dep_perm_disability`, `relationship`) VALUES
...
--
ALTER TABLE `dependent`
  MODIFY `dep_id` bigint(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
COMMIT;
