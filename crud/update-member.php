...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $name = $row["name"];
    $mother_mdn_name = $row["mother_mdn_name"];
    $spouse = ($row["spouse"] != "N/A") ? $row["spouse"] : "";
    $birth_date = $row["birth_date"];
    $birth_place = $row["birth_place"];
    $sex = $row["sex"];
    $civil_status = $row["civil_status"];
    $citizenship = $row["citizenship"];
    $philsys_id_no = ($row["philsys_id_no"] != 0) ? $row["philsys_id_no"] : "";
    $tin = ($row["tin"] != 0) ? $row["tin"] : "";
    $perm_adrs = $row["perm_adrs"];
    $mailing_adrs = $row["mailing_adrs"];
    $home_phone_no = ($row["home_phone_no"] != 0) ? $row["home_phone_no"] : "";
    $mobile_no = $row["mobile_no"];
    $business_directline = ($row["business_directline"] != 0) ? $row["business_directline"] : "";
    $email = $row["email"];
    $contributor = $row["contributor"];
    $contributor_type = $row["contributor_type"];
    
    if ($row["contributor_type"] == "Individual" || $row["contributor_type"] == "Sole Proprietor" || $row["contributor_type"] == "Group Enrollment Scheme") {
        $self_earning_indi = $row["contributor_type"];
    } else if ($row["contributor_type"] == "Land-Based" || $row["contributor_type"] == "Sea-Based") {
        $migrant_worker = $row["contributor_type"];
    } else {
        $self_earning_other = $row["contributor_type"];
    }

    $pra_srrv_no = $row["pra_srrv_no"];
    $acr_icard_no = $row["acr_icard_no"];
    $pwd_id_no = $row["pwd_id_no"];
    $profession = ($row["profession"] != "N/A") ? $row["profession"] : "";
...
<body>
    <div class="global-container">
        ...
        <div class="nav">
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="../admin/admin-simple.php"><i class="bi bi-code-slash"></i><span>SQL Codes</span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="main-content">
            <div class="content">
                ...
                <form id="registration-form" method="post" class="form">
                    ...
                    <input id="con-value" type="hidden" name="contributor" value="<?php echo $contributor; ?>">
                    <input id="contype-value" type="hidden" name="contributor_type" value="<?php echo $contributor_type; ?>">
                    <!-- Personal Details -->
                    ...
                    <div class="container-form">
                        <div>
                            ...
                            <input id="input-name" type="text" class="input-form" name="name" value="<?php echo $name; ?>">
                        </div>
                        <div>
                            <label class="label-form">Mother's Maiden Name<small>&nbsp;*</small></label>
                            <input id="input-mother" type="text" class="input-form" name="mother_mdn_name" value="<?php echo $mother_mdn_name; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Spouse <span>(if Married)</span></label>
                            <input id="input-spouse" type="text" class="input-form" name="spouse" value="<?php echo $spouse; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Date of Birth<small>&nbsp;*</small></label>
                            <input id="input-bday" type="date" class="input-form" name="birth_date" value="<?php echo $birth_date; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Place of Birth<small>&nbsp;*</small> <span>(City/Municipality/Province/Country)</span></label>
                            <input id="input-bplace" type="text" class="input-form" name="birth_place" value="<?php echo $birth_place; ?>">
                        </div>
                        <div>
                            <label class="label-form">Sex<small>&nbsp;*</small></label>
                            <div class="with-radio-btn">
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="sex" <?php if ($sex=="M") echo "checked";?> onclick="displayRadioValue()" value="M">
                                    <label>Male</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="sex" <?php if ($sex=="F") echo "checked";?> onclick="displayRadioValue()" value="F">
                                    <label>Female</label>
                                </div>
                            </div>
                        </div>
                        <div class="column-2">
                            ...
                            <div class="with-radio-btn">
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="civil_status" <?php if ($civil_status=="S") echo "checked";?> onclick="displayRadioValue()" value="S">
                                    <label>Single</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="civil_status" <?php if ($civil_status=="A") echo "checked";?> onclick="displayRadioValue()" value="A">
                                    <label>Annulled</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="civilStatus-married" type="radio" class="radio-form" name="civil_status" <?php if ($civil_status=="M") echo "checked";?> onclick="displayRadioValue()" value="M">
                                    <label>Married</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="civil_status" <?php if ($civil_status=="W") echo "checked";?> onclick="displayRadioValue()" value="W">
                                    <label>Widow/er</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="civil_status" <?php if ($civil_status=="LS") echo "checked";?> onclick="displayRadioValue()" value="LS">
                        ...
                        <div class="column-2">
                            ...
                            <div class="with-radio-btn">
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="citizenship" <?php if ($citizenship=="F") echo "checked";?> onclick="displayRadioValue()" value="F">
                                    <label>Filipino</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="citizenship" <?php if ($citizenship=="FN") echo "checked";?> onclick="displayRadioValue()" value="FN">
                                    <label>Foreign National</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="citizenship" <?php if ($citizenship=="DC") echo "checked";?> onclick="displayRadioValue()" value="DC">
                        ...
                        <div>
                            ...
                            <input id="input-philsys"  type="number" class="input-form" name="philsys_id_no" value="<?php echo $philsys_id_no; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Taxpayer Identification Number <span>(Optional)</span></label>
                            <input id="input-tin" type="number" class="input-form" name="tin" value="<?php echo $tin; ?>">
                        </div>
                    </div>
                    ...
                    <div class="container-form">
                        <div class="column-2">
                            ...
                            <input id="input-permAdrs" type="text" class="input-form" name="perm_adrs" value="<?php echo $perm_adrs; ?>">    
                        </div>
                        <div class="column-2">
                            ...
                            <input id="input-mailAdrs" type="text" class="input-form" name="mailing_adrs" value="<?php echo $mailing_adrs; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Home Phone Number</label>
                            <input id="input-homePhone" type="number" class="input-form" name="home_phone_no" value="<?php echo $home_phone_no; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Mobile Number<small>&nbsp;*</small></label>
                            <input id="input-mobile" type="number" class="input-form" name="mobile_no" value="<?php echo $mobile_no; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Business <span>(Direct Line)</span></label>
                            <input id="input-business" type="number" class="input-form" name="business_directline" value="<?php echo $business_directline; ?>">
                        </div>
                        <div>
                            <label class="label-form d-block">Email Address<small>&nbsp;*</small></label>
                            <input id="input-email" type="email" class="input-form" name="email" value="<?php echo $email; ?>">
                        </div>
                    </div>
                    ...
                    <div class="container-form contributors">
                        <div class="column-2">
                            ...
                            <div class="container-contributor">
                                ...
                                <div class="d-flex align-items-center">
                                    <input id="radio-LM" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="LM") echo "checked";?> onclick="showConType(this.value)" value="LM">
                                    <label>Lifetime Member</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="FD") echo "checked";?> onclick="showConType(this.value)" value="FD">
                                    <label>Family Driver</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-EP" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="EP") echo "checked";?> onclick="showConType(this.value)" value="EP">
                                    <label>Employed Private</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="K") echo "checked";?> onclick="showConType(this.value)" value="K">
                                    <label>Kasambahay</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-SI" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="SI") echo "checked";?> onclick="showConType(this.value)" value="SI">
                                    <label>Self-Earning Individual</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-MW" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="MW") echo "checked";?> onclick="showConType(this.value)" value="MW">
                                    <label>Migrant Worker</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-EG" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="EG") echo "checked";?> onclick="showConType(this.value)" value="EG">
                                    <label>Employed Government</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-FN" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="FN") echo "checked";?> onclick="showConType(this.value)" value="FN">
                                    <label>Foreign National</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="PP") echo "checked";?> onclick="showConType(this.value)" value="PP">
                                    <label>Professional Practitioner</label>
                                </div>
                                <div class="d-flex align-items-center column-2">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="FDL") echo "checked";?> onclick="showConType(this.value)" value="FDL">
                        ...
                        <div class="column-2">
                            <div class="container-contributor">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="SC") echo "checked";?> onclick="showConType(this.value)" value="SC">
                                    <label>Senior Citizen</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="P") echo "checked";?> onclick="showConType(this.value)" value="P">
                                    <label>PAMANA</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="LGU") echo "checked";?> onclick="showConType(this.value)" value="LGU">
                                    <label>LGU-sponsored</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="L") echo "checked";?> onclick="showConType(this.value)" value="L">
                                    <label>Listahanan</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="NGA") echo "checked";?> onclick="showConType(this.value)" value="NGA">
                                    <label>NGA-sponsored</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="KK") echo "checked";?> onclick="showConType(this.value)" value="KK">
                                    <label>KIA/KIKO</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="PS") echo "checked";?> onclick="showConType(this.value)" value="PS">
                                    <label>Private-sponsored</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="PM") echo "checked";?> onclick="showConType(this.value)" value="PM">
                                    <label>4Ps/MCCT</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input id="radio-PWD" type="radio" class="radio-form" name="contributor" <?php if ($contributor=="PWD") echo "checked";?> onclick="showConType(this.value)" value="PWD">
                                    <label>Person with Disability</label>
                                </div>
                                <div class="d-flex align-items-center column-2">
                                    <input type="radio" class="radio-form" name="contributor" <?php if ($contributor=="BN") echo "checked";?> onclick="showConType(this.value)" value="BN">
                    ...
                    <div class="container-form member-type">
                        ...
                        <div id="type-SI" class="hidden column-2">
                            ...
                            <div class="container-type">
                                ...
                                <div class='no-grid with-radio-btn'>
                                    <div class='d-flex align-items-center'>
                                        <input type='radio' class='radio-form' name='self_earning_indi' <?php if ($self_earning_indi=="Individual") echo "checked";?> onclick="forConType(this.value)" value='Individual'>
                                        <label>Individual</label>
                                    </div>
                                    <div class='d-flex align-items-center'>
                                        <input type='radio' class='radio-form' name='self_earning_indi' <?php if ($self_earning_indi=="Sole Proprietor") echo "checked";?> onclick="forConType(this.value)" value='Sole Proprietor'>
                                        <label>Sole Proprietor</label>
                                    </div>
                                    <div class='d-flex align-items-center'>
                                        <input type='radio' class='radio-form' name='self_earning_indi' <?php if ($self_earning_indi=="Group Enrollment Scheme") echo "checked";?> onclick="forConType(this.value)" value='Group Enrollment Scheme'>
                        ...
                        <div id="type-MW" class="hidden column-2">
                            ...
                            <div class="container-type">
                                ...
                                <div class="no-grid with-radio-btn">
                                    <div class="d-flex align-items-center">
                                        <input type="radio" class="radio-form" name="migrant_worker" <?php if ($migrant_worker=="Land-Based") echo "checked";?>  onclick="forConType(this.value)" value="Land-Based">
                                        <label>Land-Based</label>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <input type="radio" class="radio-form" name="migrant_worker" <?php if ($migrant_worker=="Sea-Based") echo "checked";?>  onclick="forConType(this.value)" value="Sea-Based">
                            ...
                            <div class="container-type">
                                <div class="with-grid">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input id="input-praSSRV" type="number" class="input-form" name="pra_srrv_no" value="<?php echo $pra_srrv_no; ?>">
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <label>ACR I-Card No.</label>
                                        <input id="input-acrICard" type="number" class="input-form" name="acr_icard_no" value="<?php echo $acr_icard_no; ?>">
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="container-type">
                                <div class="with-grid">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input id="input-pwdID" type="number" class="input-form" name="pwd_id_no" value="<?php echo $pwd_id_no; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="profession" class="column-2">
                            ...
                            <input id="input-profession" type="text" class="input-form" name="profession" value="<?php echo $profession; ?>">
                        </div>
                        <div>
                            <label class="label-form">Monthly Income<small>&nbsp;*</small></label>
                            <input id="input-income" type="number" class="input-form" name="monthly_income" value="<?php echo floor($monthly_income); ?>">
                        </div>
                        <div>
                            <label class="label-form">Proof of Income<small>&nbsp;*</small></label>
                            <input id="input-incomeProof" type="text" class="input-form" name="income_proof" value="<?php echo $income_proof; ?>">
                        </div>
                    </div>
                    <div class="registration-btns">
                        <a id="clearButton" type="button" class="clear-btn text-decoration-none" href="../admin/admin-members.php">Cancel</a>
                        <button id="checkButton" type="button" class="submit-btn" onclick="displayInputValue()">Update</button>
                    </div>
                            ...
                            <div class="modalContent">
                                <div class="modalBody">
                                    ...
                                    <div class="review-btns">
                                        ...
                                        <button type="submit" class="submit-btn" onclick="memberUpdated(<?php echo $pin; ?>)">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <a href="../admin/admin-home.php" class="philhealth-logo">
    ...
    <script>
        // Submitting the form
        function memberUpdated(pin) {
            // Set the localStorage item
            localStorage.setItem('memberUpdated', pin);
        }
        
        // Display the contributor type if checked
        document.addEventListener('DOMContentLoaded', function() {
            // Function to check the contributor
            function checkRadioButton() {
                var valueCon = document.getElementById('con-value').value;
                var valueConType = document.getElementById('contype-value').value;
                var radioMW = document.getElementById("radio-MW");
                var radioFN = document.getElementById("radio-FN");
                var radioLM = document.getElementById("radio-LM");
                var radioEP = document.getElementById("radio-EP");
                var radioSI = document.getElementById("radio-SI");
                var radioEG = document.getElementById("radio-EG");
                var radioPWD = document.getElementById("radio-PWD");
                ...
                if (radioLM.checked || radioEP.checked || radioEG.checked) {
                    showConType(valueCon);
                    profession.classList.add("hidden");
                } else {
                    showConType(valueCon);
                    forConType(valueConType);
                }
